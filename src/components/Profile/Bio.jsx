    ...
    return (
        <>
            ...
            {(isOpen && isMe) && <div className=' '>
                ...
                <button onClick={closeModal} type="submit" className="inline-flex mx-3 items-center px-5 py-2.5 my-2 text-sm font-medium text-center text-white bg-red-700 rounded-lg focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 hover:bg-blue-800">
                    close
                </button>
            </div>
