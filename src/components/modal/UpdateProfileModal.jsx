                ...
                <div className="max-w-2xl px-4 py-8 mx-auto lg:py-16 bg-gray-900">
                    ...
                    <form action="#" onSubmit={handleSubmit(submitForm)}>
                        ...
                        <div className="flex items-center space-x-4">
                            <button type="submit" class="text-white bg-sky-700 hover:bg-sky-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                                Update profile
                            </button>
